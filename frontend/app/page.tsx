...
export default function Home() {
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0a]">
            {/* Enhanced Navigation Sidebar with integrated header functions */}
            <NavigationSidebar
                isOpen={sidebarOpen}
            ...
            {/* Analytics Modal */}
            {analyticsOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm" onClick={() => setAnalyticsOpen(false)}>
                    <div className="glass-card w-full max-w-6xl max-h-[90vh] overflow-y-auto p-8 scrollbar-dark bg-[#0d0d0f]/95" onClick={(e) => e.stopPropagation()}>
                        <div className="flex items-center justify-between mb-6">
                            <h2 className="text-2xl font-bold text-white">📊 Analytics Dashboard</h2>
                            <button onClick={() => setAnalyticsOpen(false)} className="p-2 rounded-lg hover:bg-white/[0.08] transition-colors">
