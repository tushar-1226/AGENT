...
export default function EnhancedSidebar({
    ...
    return (
        <>
            ...
            {/* Sidebar */}
            <div
                className={`fixed top-0 left-0 h-full w-80 bg-[#0d0d0d] border-r border-white/[0.08] z-50 transform transition-transform duration-300 flex flex-col ${isOpen ? 'translate-x-0' : '-translate-x-full'
                    }`}
            >
                {/* Header */}
                <div className="flex items-center justify-between p-4 border-b border-white/[0.08]">
                    <h2 className="text-lg font-semibold text-white">F.R.I.D.A.Y.</h2>
                    <button
                        onClick={onToggle}
                ...
                <div className="flex border-b border-white/[0.08]">
                    <button
                        ...
                        className={`flex-1 px-4 py-3 text-xs font-semibold transition-colors ${activeTab === 'chats'
                    ...
                    <button
                        ...
                        className={`flex-1 px-4 py-3 text-xs font-semibold transition-colors ${activeTab === 'prompts'
                    ...
                    <button
                        ...
                        className={`flex-1 px-4 py-3 text-xs font-semibold transition-colors ${activeTab === 'settings'
                ...
                <div className="flex-1 overflow-y-auto scrollbar-dark">
                    ...
                    {activeTab === 'prompts' && (
                        <SavedPrompts onSelectPrompt={(prompt) => {
                            if (onSelectPrompt) {
            ...
            {!isOpen && (
                <button
                    onClick={onToggle}
                    className="fixed top-24 left-4 z-[9999] p-3 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-200"
                    title="Open sidebar"
                >
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
